...
app.listen(port, () => {
  console.log(`[wa] Worker WhatsApp escuchando en http://0.0.0.0:${port}`);
  console.log(`[wa] Sesión en: ./data/wa`);
  console.log(
    `[wa] Para exponerla con Tailscale Funnel: tailscale serve funnel ${port}`,
  );
  void initWhatsApp();
});